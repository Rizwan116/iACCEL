  ...
  return (
    <div className="w-full mx-auto">
      <div data-sal="slide-up"
        data-sal-delay="400"
        data-sal-duration="800"  style={{alignItems:"center"}} className="flex flex-col lg:flex-row gap-6 lg:gap-6 justify-center items-start mb-12 md:md-20 px-10 md:px-48 mt-16 md:mt-24 ">
      ...
      <div data-sal="slide-right"
        data-sal-delay="400"
        data-sal-duration="800"  className="flex flex-wrap mt-0 md:mt-5">
        ...
        >
          ...
          <img src={BackgroundImage1} alt="" className='w-3/5 md:w-full h-auto' />
          </Link>
        ...
        >
           <Link className='flex justify-center'> 
          <img src={BackgroundImage2} alt="" className='w-3/5 md:w-full h-auto' />
          </Link>
        ...
        >
          <Link className='flex justify-center'> 
          <img src={BackgroundImage3} alt="" className='w-3/5 md:w-full h-auto' />
          </Link>
        ...
        >
          <Link className='flex justify-center'> 
          <img src={BackgroundImage4} alt="" className='w-3/5 md:w-full h-auto' />
          </Link>
        ...
        >
          <Link className='flex justify-center'> 
          <img src={BackgroundImage5} alt="" className='w-3/5 md:w-full h-auto' />
          </Link>
